...
export const profiles = pgTable("profiles", {
  ...
  discordNitroEnabled: boolean("discord_nitro_enabled").default(false),
  discordActivityName: text("discord_activity_name"),
...
export const insertProfileSchema = createInsertSchema(profiles).pick({
  ...
  discordNitroEnabled: true,
  discordActivityName: true,
  discordActivityDetails: true,
  discordActivityState: true,
  discordActivityType: true,
  discordStatus: true,
  discordCustomStatus: true,
  spotifyEnabled: true,
